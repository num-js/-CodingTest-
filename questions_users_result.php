<?php
	...
	$emailQ_U = $_SESSION['emailQ_U']; //Q_U  Email
	$titleQ_U = $_SESSION['titleQ_U'];
	$descriptionQ_U = $_SESSION['descriptionQ_U'];
	
	$tqn = $_SESSION['tqn'];	//Total Question Numbers
	$corr_ans = 0;
	$wrong_ans = 0;
	$attempt = 0;
	$no_attempt = 0;

	$query = "SELECT * FROM questions_users WHERE email='$emailQ_U' && title='$titleQ_U' && description='$descriptionQ_U' ";
...
<div class="container">
 <div class="jumbotron">
  ...
  <table class="table table-hover" style="text-align:center;font-family:comic sans MS;">
   ...
   <h5 align="center">Test Type : <?php echo $titleQ_U ?></h5>
   <br>
   <tr>
...
<br>
 ...
 <center>
	...
	<div style="display:flex-box;align-items: center;">
		<a href="questions_users_paper.php" class="btn btn-primary">Try Again</a>
  ...
  <script type="text/javascript">
		$(document).ready(function(){
			$('#Show_answers').click(function(){
				$('#show').load('inc/questions_users_corr_ans.php',function(){
				});
			});
		});
   </script>
...
$(document).ready(function(){
	function insertResult(){
		...
		var descriptionQ_U = "<?php echo $descriptionQ_U; ?>";
